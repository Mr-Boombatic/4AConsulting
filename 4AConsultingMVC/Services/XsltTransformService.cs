...
namespace _4AConsultingMVC.Services
{
    public static class XsltTransformService
    {
        ...
        private static string GetTemplatePath(string templateName)
        {
            ...
            string templatePath = Path.Combine(baseDirectory, "App_Data", "XsltTemplates", templateName);
            
            if (!File.Exists(templatePath))
            {
                string alternativePath = Path.Combine(Directory.GetCurrentDirectory(), "App_Data", "XsltTemplates", templateName);
